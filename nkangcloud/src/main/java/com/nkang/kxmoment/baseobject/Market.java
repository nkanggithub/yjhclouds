...
public class Market {
	...
	public Market(){
		...
		arrayList.add(new String[]{"重庆销售","康宁","15123944895"});
		arrayList.add(new String[]{"重庆销售","天小婷","13661995272"});
		arrayList.add(new String[]{"重庆销售","杨康莉","13661995272"});
		arrayList.add(new String[]{"重庆销售","杨惟翔","13661995272"});
	}
