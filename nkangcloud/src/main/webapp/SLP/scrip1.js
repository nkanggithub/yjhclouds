...
/* 1  */ (function($){
/* 2  */     $.fn.extend({
/* 3  */         numAnim: function(options) {
/* 4  */             if ( ! this.length)
/* 5  */                 return false;
/* 6  */ 
/* 7  */             this.defaults = {
/* 8  */                 endAt: 2560,
/* 9  */                 numClass: 'autogen-num',
/* 10 */                 duration: 2,   // seconds
/* 11 */                 interval: 30  // ms
/* 12 */             };
/* 13 */             var settings = $.extend({}, this.defaults, options);
/* 14 */ 
/* 15 */             var $num = $('<span/>', {
/* 16 */                 'class': settings.numClass 
/* 17 */             });
/* 18 */ 
/* 19 */             return this.each(function() {
/* 20 */                 var $this = $(this);
/* 21 */ 
/* 22 */                 // Wrap each number in a tag.
/* 23 */                 var frag = document.createDocumentFragment(),
/* 24 */                     numLen = settings.endAt.toString().length;
/* 25 */                 for (x = 0; x < numLen; x++) {
/* 26 */                     var rand_num = Math.floor( Math.random() * 10 );
/* 27 */                     frag.appendChild( $num.clone().text(rand_num)[0] )
/* 28 */                 }
/* 29 */                 $this.empty().append(frag);
/* 30 */ 
/* 31 */                 var get_next_num = function(num) {
/* 32 */                     ++num;
/* 33 */                     if (num > 9) return 0;
/* 34 */                     return num;
/* 35 */                 };
/* 36 */ 
/* 37 */                 // Iterate each number.
/* 38 */                 $this.find('.' + settings.numClass).each(function() {
/* 39 */                     var $num = $(this),
/* 40 */                         num = parseInt( $num.text() );
/* 41 */ 
/* 42 */                     var interval = setInterval( function() {
/* 43 */                         num = get_next_num(num);
/* 44 */                         $num.text(num);
/* 45 */                     }, settings.interval);
/* 46 */ 
/* 47 */                     setTimeout( function() {
/* 48 */                         clearInterval(interval);
/* 49 */                     }, settings.duration * 1000 - settings.interval);
/* 50 */                 });
...
/* 53 */                     $this.text( settings.endAt.toString() );
/* 54 */                 }, settings.duration * 1000);
/* 55 */             });
/* 56 */         }
/* 57 */     });
/* 58 */ })(jQuery);
...
/* 55  */           vertical: {}
/* 56  */         };
/* 57  */         this.element[contextKey] = this.id;
...
/* 233 */         idList = (_ref = this.element[waypointKey]) != null ? _ref : [];
/* 234 */         idList.push(this.id);
/* 235 */         this.element[waypointKey] = idList;
/* 236 */       }
/* 237 */ 
...
/* 300 */           context = contexts[contextElement[0][contextKey]];
...
/* 310 */         return methods._invoke.call(this, 'disable');
/* 311 */       },
/* 312 */       enable: function() {
/* 313 */         return methods._invoke.call(this, 'enable');
/* 314 */       },
/* 315 */       destroy: function() {
/* 316 */         return methods._invoke.call(this, 'destroy');
/* 317 */       },
...
/* 351 */       _invoke: function(method) {
/* 352 */         this.each(function() {
/* 353 */           var waypoints;
/* 354 */ 
...
/* 404 */           collection = (_ref = contexts[$(contextSelector)[0][contextKey]]) != null ? _ref.waypoints : void 0;
/* 405 */         }
/* 406 */         if (!collection) {
/* 407 */           return [];
/* 408 */         }
...
/* 482 */ 
/* 483 */         context = contexts[$(selector)[0][contextKey]];
/* 484 */         if (!context) {
/* 485 */           return [];
/* 486 */         }
/* 487 */         waypoints = [];
...
/* 1  */ // Generated by CoffeeScript 1.6.2
/* 2  */ /*
/* 3  *| Sticky Elements Shortcut for jQuery Waypoints - v2.0.4
/* 4  *| Copyright (c) 2011-2014 Caleb Troughton
/* 5  *| Dual licensed under the MIT license and GPL license.
/* 6  *| https://github.com/imakewebthings/jquery-waypoints/blob/master/licenses.txt
/* 7  *| */
...
/* 5  */ 
/* 6  */ 
/* 7  */ jQuery.fn.infinitecarousel = function(previous, next, options){
/* 8  */ 	var sliderList = jQuery(this).children()[0];
/* 9  */ 	
/* 10 */ 	if (sliderList) {
/* 11 */ 		var increment = jQuery(sliderList).children().outerWidth(true),
/* 12 */ 		elmnts = jQuery(sliderList).children(),
/* 13 */ 		numElmts = elmnts.length,
/* 14 */ 		sizeFirstElmnt = increment,
/* 15 */ 		shownInViewport = Math.round(jQuery(this).width() / sizeFirstElmnt),
/* 16 */ 		firstElementOnViewPort = 1,
/* 17 */ 		isAnimating = false;
/* 18 */ 		
/* 19 */ 		for (i = 0; i < shownInViewport; i++) {
/* 20 */ 			jQuery(sliderList).css('width',(numElmts+shownInViewport)*increment + increment + "px");
/* 21 */ 			jQuery(sliderList).append(jQuery(elmnts[i]).clone());
/* 22 */ 		}
/* 23 */ 		
/* 24 */ 		jQuery(previous).click(function(event){
/* 25 */ 			if (!isAnimating) {
/* 26 */ 				if (firstElementOnViewPort == 1) {
/* 27 */ 					jQuery(sliderList).css('left', "-" + numElmts * sizeFirstElmnt + "px");
/* 28 */ 					firstElementOnViewPort = numElmts;
/* 29 */ 				}
/* 30 */ 				else {
/* 31 */ 					firstElementOnViewPort--;
/* 32 */ 				}
/* 33 */ 				
/* 34 */ 				jQuery(sliderList).animate({
/* 35 */ 					left: "+=" + increment,
/* 36 */ 					y: 0,
/* 37 */ 					queue: true
/* 38 */ 				}, "swing", function(){isAnimating = false;});
/* 39 */ 				isAnimating = true;
/* 40 */ 			}
/* 41 */ 			
/* 42 */ 		});
/* 43 */ 		
/* 44 */ 		jQuery(next).click(function(event){
/* 45 */ 			if (!isAnimating) {
/* 46 */ 				if (firstElementOnViewPort > numElmts) {
/* 47 */ 					firstElementOnViewPort = 2;
/* 48 */ 					jQuery(sliderList).css('left', "0px");
/* 49 */ 				}
/* 50 */ 				else {

/* jquery.infinite-carousel.js */

/* 51 */ 					firstElementOnViewPort++;
/* 52 */ 				}
/* 53 */ 				jQuery(sliderList).animate({
/* 54 */ 					left: "-=" + increment,
/* 55 */ 					y: 0,
/* 56 */ 					queue: true
/* 57 */ 				}, "swing", function(){isAnimating = false;});
/* 58 */ 				isAnimating = true;
/* 59 */ 			}
/* 60 */ 		});
/* 61 */ 	}
