...
<html lang="en" class="no-js">
	...
	<% 
		Object processSuccMsg = request.getSession().getAttribute("processSuccMsg"); 
		processSuccMsg = processSuccMsg==null?"":processSuccMsg;
	%>
	</head>
	<body>
		...
		<div class="container">
			<div class="content">
				<div class="box">
				<form id="file_upload" name="file_upload" action="../fileUpload/upload" enctype="multipart/form-data" method="post">
					...
					<p><p>
					<% if (processSuccMsg != null && !processSuccMsg.equals("") ){%>
					<div class="alert alert-success alert-dismissable" role="alert" style="margin-bottom: 0px;">
