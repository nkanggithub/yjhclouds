...
<div id="cn" style="display:none">${ cn }</div>
<div id="my" style="display:none">${ my }</div>
<div id="ru" style="display:none">${ ru }</div>
<div id="kr" style="display:none">${ kr }</div>
<div id="sg" style="display:none">${ sg }</div>
<div id="us" style="display:none">${ us }</div>
...
<script>
var cnt=document.getElementById("cn").innerHTML;
var ust=document.getElementById("us").innerHTML;
var sgt=document.getElementById("sg").innerHTML;
var rut=document.getElementById("ru").innerHTML;
var krt=document.getElementById("kr").innerHTML;
var myt=document.getElementById("my").innerHTML;
	var map_config = {
