										...
										<div class="panel-group" id="accordion">
											<div id="DivLearnings">
												<div style="float: right; padding-bottom: 10px;">
													<a class="" data-toggle="modal" href="#LBreadmore">Manage
														your Profile </a>
												</div>

												<div id="LBreadmore" class="modal hide fade" tabindex="-1"
													...
													<div class="modal-footer">
														...
														<button class="btnAthenaSave" data-dismiss="modal"
													...
													<tbody>
														<tr>
															<td class="text-right"><span
																style="text-align: right;"><strong>Profile
																		Photo:</strong></span></td>
															<td>NKANG</td>
														</tr>
														<tr>
															<td class="text-right"><span
																style="text-align: right;"><strong>Nick
																		Name:</strong></span></td>
															<td>NKANG</td>
														</tr>
														<tr>
															<td class="text-right"><span
																style="text-align: right;"><strong>Legal
																		Name:</strong></span></td>
															<td>NKANG</td>
														</tr>
														<tr>
															<td class="text-right"><span
																style="text-align: right;"><strong>Email:</strong></span>
															</td>
															<td>NKANG</td>
														</tr>
														<tr>
															<td class="text-right"><span
																style="text-align: right;"><strong>Phone:</strong></span>
															</td>
															<td>NKANG</td>
														</tr>
														<tr>
